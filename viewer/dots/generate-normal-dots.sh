...
montage $(ls ../static/images/?.png ../static/images/??.png ../static/images/???.png | sort -t/ -k2 -n | xargs) -background transparent -gravity NorthWest -geometry '39x39>+0+0' -tile 10x ..static/images/sprite-2013-01-14.png

rm ../static/images/?.png ../static/images/??.png ../static/images/???.png
