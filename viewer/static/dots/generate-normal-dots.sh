...
montage $(ls dots/?.png dots/??.png dots/???.png | sort -t/ -k2 -n | xargs) -background transparent -gravity NorthWest -geometry '39x39>+0+0' -tile 10x dots/sprite-2013-01-14.png
